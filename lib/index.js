...
cmd.command('new <branches...>')
  ...
  .action(async (branches, {pane: paneOpt, session, baseRef: baseRefOpt, detach, workspace, tmux: tmuxOpt, cmd: cmdOpt, focus: focusOpt, parent: {dryRun}}) => {
    try {
      ...
      for (const branch of branches) {
        ...
        if (dryRun) {
          ...
          await runHook(config.hooks, {window, wtd, branch, configDir: resolveHooksConfigDir(cwd)})
